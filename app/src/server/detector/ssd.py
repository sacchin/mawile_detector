...
from server.detector.ssd_layers import Normalize
from server.detector.ssd_layers import PriorBox
...
def SSD300(input_shape, num_classes=21):
    ...
    #                                  name='fc6')(net['pool5'])
    net['fc6'] = Convolution2D(1024, (3, 3), activation="relu", padding="same", 
                                     dilation_rate=(6, 6), name="fc6")(net['pool5'])
